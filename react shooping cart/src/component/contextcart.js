    ...
    <div>
      <header className="bg-light navbar">
        <div className="continue_shopping ">
          <img
            src="https://www.pngarts.com/files/2/Left-Arrow-PNG-Free-Download.png"
            alt="arrow"
            className="arrow_icon"
          />
          <h3>Unlimited Shooping</h3>
        </div>
        <div className="cart_icons">
          <img
            src="https://maxcdn.icons8.com/Share/icon/nolan/Shopping/shopping_cart1600.png"
            alt="cart"
            className="cart_icon"
          />
      ...
      <section className="main_cart_section">
        ...
        <p className="total_items">
          you have <span className="total_items_count">{totalitems}</span> item
          in shopping cart
        </p>
        ...
        <div className="clear_cart">
          <button className="clearout" onClick={clear}>
            clear
          </button>
        </div>
      </section>
